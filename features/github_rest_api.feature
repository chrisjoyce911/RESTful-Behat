...
Scenario: GitHub behat Demo Api my repo
	Given I request "/repos/chrisjoyce911/RESTful-Behat"
	Then the response should be JSON
	And the response status code should be 200
	And the response has a "name" property
	And the "name" property equals "RESTful-Behat"

Scenario: GitHub behat Demo Api
	Given I request "/"
	Then the response should be JSON
  
  Scenario: GitHub behat JAON equals
	Given I request "/"
	Then the response should be JSON
